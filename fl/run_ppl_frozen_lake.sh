...
si_size=11
fl_slip_prob=0
ppl_indiv_size_min=3
ppl_indiv_size_max=4
ppl_pop_size_mult=2
...
c_rho=5
#num_train_rollouts=$(python3 -c "import math; print($fl_size_si + math.ceil($c_rho * $fl_size_si * $fl_slip_prob))")
#tests_per_si=100
...
ppl_num_gens=100
num_search_dims=$(($ppl_indiv_size_max * 5))  # 5 alleles for each rule in FL
